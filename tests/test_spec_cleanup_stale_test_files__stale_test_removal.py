...
NON_STALE_SPEC_FILES = {
    ...
    "test_spec_unify_api_route_style__redirect_compat.py",
    "test_spec_unify_api_route_style__route_renaming.py",
    "test_spec_unify_api_route_style__test_coverage.py",
}
