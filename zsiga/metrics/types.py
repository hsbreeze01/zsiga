    ...
    "tasks": [
        {
            ...
            "deliverables": ["agent/intent_router.py", "pipeline/orchestrator.py"],
        ...
        },
        {
            ...
            "deliverables": ["agent/task_decomposer.py", "pipeline/orchestrator.py"],
        ...
        },
        {
            ...
            "deliverables": ["agent/todo.py", "zsiga/metrics/dashboard.py"],
        ...
        },
        {
            ...
            "deliverables": ["agent/escalation.py", "pipeline/orchestrator.py"],
        ...
        },
        {
            ...
            "deliverables": ["pipeline/implementer.py"],
