...
<div class="hero">
  ...
  <div class="hero-info">
    ...
    <div id="phase-indicator" style="font-size:0.8rem;color:#64748b;margin-bottom:0.5rem">CLARIFY → ENRICH → IMPLEMENT → REVIEW → VERIFY → OPTIMIZE → REFLECT → DELIVER</div>
    <span id="daemon-state" class="state-badge {state}">{state_label}</span>
  </div>
</div>
