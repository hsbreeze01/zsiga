...
class PipelineConfig:
    def __init__(self, max_changes_per_cycle: int = 3, impl_timeout_minutes: int = 20,
        ...
        proposal_gate_score_accept: int = 10,
        proposal_gate_score_pushback: int = 6,
...
def load_config(path: str = None) -> ZsigaConfig:
    ...
    proposal_gate_score_accept=pipeline_raw.get("proposal_gate", {}).get("score_accept", 10),
    proposal_gate_score_pushback=pipeline_raw.get("proposal_gate", {}).get("score_pushback", 6),
