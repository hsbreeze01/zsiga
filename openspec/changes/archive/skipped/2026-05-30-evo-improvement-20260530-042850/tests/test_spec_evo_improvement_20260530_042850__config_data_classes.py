...
class TestSSHConfigConstruction:
    """Spec: config-data-classes — SSHConfig full construction."""
...
class TestTargetConfigDefaults:
    """Spec: config-data-classes — TargetConfig defaults."""
...
class TestLLMConfigDefaults:
    """Spec: config-data-classes — LLMConfig defaults and full construction."""
...
class TestLLMFastConfigConstruction:
    """Spec: config-data-classes — LLMFastConfig construction."""
...
class TestCompactionConfigDefaults:
    """Spec: config-data-classes — CompactionConfig defaults."""
...
class TestPipelineConfigDefaults:
    """Spec: config-data-classes — PipelineConfig defaults and budget_profiles merge."""
...
class TestIntakeConfigDefaults:
    """Spec: config-data-classes — IntakeConfig defaults."""
...
class TestSafetyConfigDefaults:
    """Spec: config-data-classes — SafetyConfig defaults."""
...
class TestGithubConfigDefaults:
    """Spec: config-data-classes — GithubConfig defaults."""
...
class TestLoggingConfig:
    """Spec: config-data-classes — LoggingConfig level normalization and defaults."""
...
class TestZsigaConfigConstruction:
    """Spec: config-data-classes — ZsigaConfig construction."""
    ...
    def test_required_and_optional_args(self):
        ...
        assert cfg.intake is intake
        assert cfg.safety is safety
