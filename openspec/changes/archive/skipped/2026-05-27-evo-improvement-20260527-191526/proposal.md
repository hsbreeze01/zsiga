...
## Summary
为无测试模块 `zsiga/daemon.py` (1056 行, 21 函数, 1 类) 添加单元测试覆盖。
...
- L919 [F541]: f-string without any placeholders
...
- `_serve_dashboard.do_GET` L726 CC=15 (64L)
- `daemon_loop` L799 CC=38 (258L)
