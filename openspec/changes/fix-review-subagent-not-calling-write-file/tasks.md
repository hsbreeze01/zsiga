...
1.1 - [ ] **Harden review prompt to enforce write_file tool call** (`zsiga/agent/reviewer.py`)
...
1.2 - [ ] **Add defensive fallback: auto-write review.md if sub-agent omits write_file** (`zsiga/agent/reviewer.py`)
...
2.1 - [ ] **Verify existing reviewer tests pass** (`tests/test_reviewer.py`)
